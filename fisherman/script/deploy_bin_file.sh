...
rsync -avz ../config_check_component.json mbr-verify:/opt/fisherman/config_check_component.json
rsync -avz ../config_fisherman.json mbr-verify:/opt/fisherman/config_fisherman.json
