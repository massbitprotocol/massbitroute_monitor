...
redis = StrictRedis(unix_socket_path="/omd/sites/node_eth_mainnet/tmp/run/redis")
...
@app.route("/push_node_eth_mainnet/<token_arg>", methods=["POST"])
def push(token_arg):
...
if __name__ == "__main__":
    ...
    app.run(debug=False, threaded=True, host="127.0.0.1", port=18700)
